...
inline Dir6 operator++(Dir6& d)
{
	return d = (Dir6)(1 + (int)d);
}

inline Dir6 CW(Dir6 d)
{
	return (Dir6)(((int)d + 1) % 6);
}
inline Dir6 CCW(Dir6 d)
{
	return (Dir6)(((int)d + 5) % 6);
}
...
inline std::string IntToStrPad(int i, unsigned n, char p)
{
